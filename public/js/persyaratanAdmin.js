     document.addEventListener('DOMContentLoaded', function () {
       ...
       const editPanduanBtn = document.getElementById('editPanduanBtn');
       ...
       const modalEditPanduan = new bootstrap.Modal(document.getElementById('modalEditPanduan'));
       const editPanduanTextarea = document.getElementById('editPanduanTextarea');
       const formEditPanduan = document.getElementById('formEditPanduan');
       const stepsOl = document.querySelector('.steps-box ol');
       ...
       editPanduanBtn.addEventListener('click', () => {
         editPanduanTextarea.value = stepsOl.innerHTML;
         modalEditPanduan.show();
       });
       formEditPanduan.addEventListener('submit', (e) => {
         e.preventDefault();

         const editedHTML = editPanduanTextarea.value.trim();
         if (!editedHTML) {
           alert('Panduan tidak boleh kosong.');
           return;
         }
         stepsOl.innerHTML = editedHTML;

         alert('Panduan berhasil disimpan.');

         modalEditPanduan.hide();
       });
     });
